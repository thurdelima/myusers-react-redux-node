      ...
      axios.post('/users/register', data)
        .then(res => {
          ...
          if(status !== true) {
            ...
            this.handleOpenDialog(message, 'You can now log in with your email and password from the home screen :D');
          }
        })
    ...
    return (
      <React.Fragment>
        <form onSubmit={this.handleRegister} className={classes.root}>
          ...
          >
            <InputLabel htmlFor="input-name">Complete Name</InputLabel>
            <Input
              id="input-name"
              name="name"
              type="text"
          ...
          >
            ...
            {(this.state.beforeSubmitError && this.state.password === '') &&
              <FormHelperText id="password-error-text">Fill in the password</FormHelperText>
            }
          </FormControl>
